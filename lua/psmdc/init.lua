...
local function set_groups(c)
  local groups = {
    ColorColumn      = { bg=c.grp.selection },
    Cursor           = { fg=c.grp.bg, bg=c.grp.caret },
    CursorColumn     = { bg=c.grp.line_highlight },
    CursorLine       = { bg=c.grp.line_highlight },
    CursorLineNr     = { fg=c.grp.fg, bg=c.grp.line_highlight },
    ...
    FoldColumn       = { fg=c.grp.line_numbers, bg=c.grp.bg },
    Folded           = {
      fg=c.clr.brown, bg=utils.blend(c.clr.brown, c.grp.bg, 0.1), attr="bold"
    },
    LineNr           = { fg=c.grp.line_numbers },
    MatchParen       = { fg=c.clr.red, bg=c.grp.bg, attr="bold" },
    ModeMsg          = { fg=c.clr.purple, bg=c.grp.inline_highlight },
    MoreMsg          = { fg=c.clr.purple, bg=c.grp.inline_highlight },
    NonText          = { fg=c.grp.comments },
    Whitespace       = { fg=c.grp.guides },
    Normal           = { fg=c.grp.fg, bg=c.grp.bg },
    Pmenu            = { fg=c.grp.fg, bg=c.grp.selection },
    PmenuSel         = { fg=c.grp.bg, bg=c.clr.pink },
    PmenuSbar        = { bg=c.grp.selection },
    PmenuThumb       = { bg=c.grp.comments },
    ...
    StatusLine       = { fg=c.clr.gray, bg=c.grp.selection },
    StatusLineNC     = { fg=c.grp.comments, bg=c.grp.selection2 },
    TabLine          = { fg=c.grp.fg, bg=c.grp.line_numbers },
    TabLineFill      = { fg=c.grp.fg, bg=c.grp.selection },
    TabLineSel       = { fg=c.grp.bg, bg=c.clr.palepink },
    Title            = { fg=c.clr.green },
    VertSplit        = { fg=c.grp.comments },
    ...
    Todo       = { fg=c.clr.orange, bg=c.grp.inline_highlight, attr="italic" },
    ...
    TSAttribute       = { fg=c.clr.blue, bg=c.grp.inline_highlight, attr="italic" },
    ...
    LspReferenceText = { bg=c.grp.selection },
    LspReferenceRead = { bg=c.grp.selection },
    LspReferenceWrite = { bg=c.grp.selection },
    LspCodeLens       = { fg=c.grp.comments },
    LspCodeLensSeparator = { fg=c.grp.guides },
